# DataStream常用算子
  ...
  <div align=center><img src="pic/常用算子1.jpg" width="100%" height="100%"></div>
...
### 3、Filter
```scala
val filter = ds.filter(new FilterFunction<Employee>() {
    @Override
...
### 4、KeyBy
  <div align=center><img src="pic/常用算子2.jpg" width="100%" height="100%"></div>
...
### 9.Union
  ...
  <div align=center><img src="pic/常用算子3.jpg" width="100%" height="100%"></div>
...
# 11、Split
  <div align=center><img src="pic/常用算子4.jpg" width="100%" height="100%"></div>
...
### 12、Select
  <div align=center><img src="pic/常用算子5.jpg" width="100%" height="100%"></div>
